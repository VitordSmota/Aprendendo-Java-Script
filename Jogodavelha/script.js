   ...
   /** function HoverJS() {
    debugger;
        ...
        box1.onclick = () => {
         ...
         debugger;}
     debugger;}
    else if (box2.value == '' || box2.value == undefined) {
        box2.onmouseover = () => { box2.style.color = "rgba(248, 248, 248, 0.7)" }
        box2.onmouseout = () => { box2.style.color = "#0d95ca" }
    }
     else if  (box3.value == '' || box3.value == undefined) {
        box3.onmouseover = () => { box3.style.color = "rgba(248, 248, 248, 0.7)" }
        box3.onmouseout = () => { box3.style.color = "#0d95ca" }
    }
     else if  (box4.value == '' || box4.value == undefined) {
        box4.onmouseover = () => { box4.style.color = "rgba(248, 248, 248, 0.7)" }
        box4.onmouseout = () => { box4.style.color = "#0d95ca" }
    }
     else if  (box5.value == '' || box5.value == undefined) {
        box5.onmouseover = () => { box5.style.color = "rgba(248, 248, 248, 0.7)" }
        box5.onmouseout = () => { box5.style.color = "#0d95ca" }
    }
     else if  (box6.value == '' || box6.value == undefined) {
        box6.onmouseover = () => { box6.style.color = "rgba(248, 248, 248, 0.7)" }
        box6.onmouseout = () => { box6.style.color = "#0d95ca" }
    }
     else if  (box7.value == '' || box7.value == undefined) {
        box7.onmouseover = () => { box7.style.color = "rgba(248, 248, 248, 0.7)" }
        box7.onmouseout = () => { box7.style.color = "#0d95ca" }
    }
     else if  (box8.value == '' || box8.value == undefined) {
        box8.onmouseover = () => { box8.style.color = "rgba(248, 248, 248, 0.7)" }
        box8.onmouseout = () => { box8.style.color = "#0d95ca" }
    }
     else if  (box9.value == '' || box9.value == undefined) {
        box9.onmouseover = () => { box9.style.color = "rgba(248, 248, 248, 0.7)" }
        box9.onmouseout = () => { box9.style.color = "#0d95ca" }
    }
